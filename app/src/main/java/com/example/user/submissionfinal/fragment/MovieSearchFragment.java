 ...
 */
public class MovieSearchFragment extends Fragment implements SearchView.OnQueryTextListener, RecyclerViewClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        svMovie = view.findViewById(R.id.sv_searchMovie);
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        gridMovieAdapter.setRecyclerViewClickListener(this);
...
//            loadData();
    ...
    public void onSaveInstanceState(@NonNull Bundle outState) {
        ...
        outState.putParcelableArrayList("movie_list",gridMovieAdapter.getMovies());
    }
